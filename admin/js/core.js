 ...
 *************************************************
 */
var UixProducts_uixCustomMetaboxes = function( obj ) {
	"use strict";


	var UixProducts_uixCustomMetaboxesConstructor = function( obj ) {
		this.init = obj;
	};

	UixProducts_uixCustomMetaboxesConstructor.prototype = {
		...
		getInstance: function() {
			...
			jQuery( document ).ready( function() {
				...
				UixProducts_uixCustomMetaboxesConstructor.prototype.radio.call( this, '.custom_radio_selector' );
				UixProducts_uixCustomMetaboxesConstructor.prototype.toggle.call( this, '.custom_toggle_selector' );
	...
	return new UixProducts_uixCustomMetaboxesConstructor( obj );
};
