	...
	UixProductsCustomMetaboxesConstructor.prototype = {
		...
		getInstance: function() {
			...
			jQuery( document ).ready( function() {
				...
				UixProductsCustomMetaboxesConstructor.prototype.upload.call( this, '.uix-products-cmb__upload-target' );
		...
		toggleSelect: function() {
			...
			jQuery( document ).ready( function() {
                ...
                jQuery( '.uix-products-cmb__text--div--toggle' ).UixProductsToggleSelectInit();
