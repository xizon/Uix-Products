...
/**
 *
 * The template for displaying  products archive lists page .
 *
 */
...
get_header(); ?>
    ...
    <section class="uix-products-section">
        <div class="container">
            ...
            <h2><?php printf( wp_kses( __( '%s', 'uix-products' ), wp_kses_allowed_html( 'post' ) ), single_cat_title( '', false ) ); ?></h2>
            <?php the_archive_description( '<h5>', '</h5>' ); ?>
