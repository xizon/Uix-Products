    ...
    class Uix_Products_GalleryMetabox {
        ...
        function css() { ?>
            <style>
                ...
                .gallery_images .wc-metabox-sortable-placeholder{width: 80px;height: 80px;box-sizing: border-box;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;border:4px dashed #ddd;background:#f7f7f7 url("data:image/png;base64,") no-repeat center}      
                .gallery_images .uix-gmb-remove {background: #eee url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAOklEQVR4AWMAgXNyDAugmAGBUcThnP8gjFCMKQ4XQBbEJoahGxMjrIYrxqWIHIWErSbaM6QED3EBDgBy6JcdtS3hSwAAAABJRU5ErkJggg==") center center no-repeat;position: absolute;top: 2px;right: 2px;border-radius: 2px;padding: 2px;display: none;width: 10px;height: 10px;margin: 0;display: none;overflow: hidden;} 
