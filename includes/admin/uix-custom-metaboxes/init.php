		...
		?>
			...
			<tr>
             ...
             <?php endif; ?> 
					...
					<!-- Begin Fields -->
					<div class="uix-products-cmb__wrapper uix-products-cmb__custom-attributes-field" data-append-id="<?php echo esc_attr( $id ); ?>_append" data-tmpl='<?php echo esc_attr( $temp_attr ); ?>'>
