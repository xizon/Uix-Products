 ...
 *************************************************
 */
 const UixProductsCustomMetaboxes = function( obj ) {
	"use strict";


	const UixProductsCustomMetaboxesConstructor = function( obj ) {
		this.init = obj;
	};

	UixProductsCustomMetaboxesConstructor.prototype = {
		...
		getInstance: function() {
			...
			jQuery( document ).ready( function() {
				...
				UixProductsCustomMetaboxesConstructor.prototype.radio.call( this, '.uix-products-cmb__radio-selector' );
				UixProductsCustomMetaboxesConstructor.prototype.toggle.call( this, '.uix-products-cmb__toggle-selector' );
				UixProductsCustomMetaboxesConstructor.prototype.color.call( this, '.uix-products-cmb__color-selector' );
				UixProductsCustomMetaboxesConstructor.prototype.tabs.call( this, '.uix-products-cmb__tabsgroup-selector' );
				UixProductsCustomMetaboxesConstructor.prototype.date.call( this, '.uix-products-cmb__date-selector' );
				UixProductsCustomMetaboxesConstructor.prototype.customAttrs.call( this, '.uix-products-cmb__custom-attributes-field', 100 );
                UixProductsCustomMetaboxesConstructor.prototype.expandItem.call( this, '.uix-products-cmb__text--div--toggle__trigger' );
                UixProductsCustomMetaboxesConstructor.prototype.titleChange.call( this, '.uix-products-cmb__text--div--toggle', '.uix-products-cmb__text--div--toggle__trigger', '.uix-products-cmb__text--div--toggle__title' );          
                UixProductsCustomMetaboxesConstructor.prototype.upload.call( this );
                UixProductsCustomMetaboxesConstructor.prototype.editor.call( this, false );
                UixProductsCustomMetaboxesConstructor.prototype.toggleSelect.call( this );
		...
		expandItem: function( selector ) {
			...
			jQuery( document ).ready( function() {
                jQuery( document ).off( 'click.UixProductsToggle' ).on( 'click.UixProductsToggle', selector, function(e) {
                    e.preventDefault();
					...
					const switchFun = function( curSel ) {
						...
						$this.find( '[data-switch-ids]' ).each( function()  {
							const _targetID      = jQuery( this ).attr( 'data-switch-ids' ),
								_targetIDs     = UixProductsGetRealIds( _targetID  );
						...
						//
						if ( allSwitchIds != '' ) {
							jQuery( UixProductsGetRealIds( allSwitchIds  ) ).closest( 'tr' ).hide();
						}
						...
						const switchTargetID = curSel.attr( 'data-switch-ids' ),
							switchTargetIDs = UixProductsGetRealIds( switchTargetID  );
				...
				jQuery( selector ).each(function(){
                    ...
                    if ( $this.hasClass( 'active' ) ) {
                        if ( tid != '' || typeof tid !== typeof undefined ) {
                            $this.closest( '[data-target-id]' ).find( '.uix-products-cmb__toggle-target' ).hide();
                            jQuery( '#' + tid ).show();
                        }
                    }
		...
		editor: function( reset ) {
			...
			jQuery( document ).ready( function() {
                ...
                //Initialize Editor
                jQuery( '.uix-products-cmb__mce-editor' ).UixProductsEditorInit({init: reset});
		...
		toggleSelect: function() {
			...
			jQuery( document ).ready( function() {
                ...
                jQuery( '.uix-products-cmb__wrapper.uix-products-cmb__custom-attributes-field.uix-products-cmb__custom-attributes-field--customlevel' ).UixProductsToggleSelectInit();
				
				//Initialize Select of Toggle
                jQuery( '.uix-products-cmb__text--div--toggle__simple-sel' ).UixProductsToggleSimpleSelectInit({ type: 'file'});
		...
		upload: function() {
			...
			jQuery( document ).ready( function() {
                ...
                const selector = '.uix-products-cmb__upload-target';
				...
				jQuery( selector ).each( function()  {
                    ...
                    $this.next( _closebtn ).off( 'click.UixUploadClose' ).on( 'click.UixUploadClose', function( event ){
                        ...
                        jQuery( this ).hide();
                        jQuery( this ).closest( '.uix-products-cmb__upload-wrapper' ).find( selector ).show();
                        jQuery( this ).closest( '.uix-products-cmb__upload-wrapper' ).find( selector ).attr( 'aria-disabled', true );
                    ...
                    $this.off( 'click.UixUpload' ).on( 'click.UixUpload', function( e ) {
                        ...
                        if ( $thisClick.attr( 'aria-disabled' ) == 'true' ) {
                            ...
                            upload_frame = wp.media( {
								title: uix_products_custom_metaboxes_lang.ed_media_title,
								button: {
								text: uix_products_custom_metaboxes_lang.ed_media_text,
                            },
                                multiple: false
                            } );
		...
		customAttrs: function( selector, max ) {
			...
			jQuery( document ).ready( function() {
				...
				jQuery( selector ).each(function(){
					...
					const $this     = jQuery( this ),
						$addButton  = $this.find( '.uix-products-cmb__custom-attributes-field__addbtn' ), //The add button selector ID or class
					...
					//Prevent duplicate function assigned
					$addButton.off( 'click.UixProductsCustomMetaboxes_customAttrs_add' ).on( 'click.UixProductsCustomMetaboxes_customAttrs_add', function( e ) {
						e.preventDefault();
						...
						if( x < maxField ){ 
                            ...
                            const uuid = UixProductsGUIDCreate();
                            ...
                            jQuery.when( jQuery( wrapperID ).length > 0 ).then( function() {
                                ...
                                if ( typeof $btn.data( 'type' ) !== typeof undefined ) {
									...
									//Initialize Select of Toggle
                                   jQuery( '.uix-products-cmb__text--div--toggle__simple-sel' ).UixProductsToggleSimpleSelectInit({ type: $btn.data( 'type' ) });
                                ...
                                //Initialize Editor
                                UixProductsCustomMetaboxesInit.editor( false );
                                
                                

                                //Initialize Uploader
                                UixProductsCustomMetaboxesInit.upload();
						...
						//Fold all items
						jQuery( '.uix-products-cmb__text--div--toggle__trigger' ).parent().removeClass( 'active' );
						jQuery( '.uix-products-cmb__text--div--toggle__trigger' ).removeClass( 'active' );
					...
					//Prevent duplicate function assigned
					jQuery( '.uix-products-cmb__custom-attributes-field__removebtn' ).off( 'click.UixProductsCustomMetaboxes_customAttrs_remove' );
					jQuery( document ).on( 'click.UixProductsCustomMetaboxes_customAttrs_remove', '.uix-products-cmb__custom-attributes-field__removebtn', function( e ) {
						e.preventDefault();
                        
                        //fixed click events firing multiple times
                        e.stopImmediatePropagation();
                        
                        if ( confirm( uix_products_custom_metaboxes_lang.delete_confirm_text ) ) {
                            const $li = jQuery( this ).closest( '.uix-products-cmb__text--div' );

                            if ( jQuery( '.uix-products-cmb__custom-attributes-field .uix-products-cmb__text--div' ).length == 1 ) {
                                $li.find( 'input' ).val( '' );
                                $li.hide();
                            } else {
                                $li.remove();
                    ...
                    jQuery( '.uix-products-cmb__custom-attributes-field' ).sortable({
                        items                   : '.uix-products-cmb__text--div--toggle--sortable',
                        handle                  : '.uix-products-cmb__custom-attributes-field__sortablebtn',
                        cursor                  : 'move',
                        ...
                        stop:function( event,ui ){
                            ...
                            //Initialize Editor
                            UixProductsCustomMetaboxesInit.editor( true );   
	...
	return new UixProductsCustomMetaboxesConstructor( obj );
};
...
//--------
const UixProductsCustomMetaboxesInit = new UixProductsCustomMetaboxes();
UixProductsCustomMetaboxesInit.getInstance(); 
...
"use strict";
    $( function() {
		...
		if ( typeof(tinymce) !== 'undefined' ) {
			...
			tinymce.PluginManager.add('uix_products_cmb_customcode', function(editor) {
				function showDialog() {
					const win = editor.windowManager.open({
						title: uix_products_custom_metaboxes_lang.ed_sourcecode_title,
						body: {
							type: 'textbox',
							name: 'uix_products_cmb_customcode',
							multiline: true,
						...
						onSubmit: function(e) {
							...
							if(editor.readonly != true){
								editor.undoManager.transact(function() {
									editor.setContent(e.data.uix_products_cmb_customcode);
								});
							}
					...
					win.find('#uix_products_cmb_customcode').value(editor.getContent({source_view: true}));

					//disable source code editing while in readonly mode
					if(editor.readonly){
						const id = win.find('#uix_products_cmb_customcode')[0]._id;
						$(win.find('#uix_products_cmb_customcode')[0]._elmCache[id]).prop('readonly', true);
					}
				...
				editor.addButton('uix_products_cmb_customcode', {
					icon: 'code',
					tooltip: uix_products_custom_metaboxes_lang.ed_sourcecode_title,
					onclick: showDialog,
					classes:'uix_products_cmb_customcode'
				});

				editor.addMenuItem('uix_products_cmb_customcode', {
					icon: 'code',
					text: uix_products_custom_metaboxes_lang.ed_sourcecode_title,
					context: 'tools',
					onclick: showDialog
				});
			});	
...
( function ( $ ) {
	'use strict';
    $.fn.UixProductsMCEEditor = function( options ) {
        ...
        this.each( function() {
            ...
            if( typeof id !== typeof undefined ) {
				...
				tinymce.init({
					...
					//---
					language_url : (uix_products_custom_metaboxes_lang.ed_lang != 'en_US' ) ? uix_products_custom_metaboxes_lang.ed_url +  'js/tinymce/langs/'+uix_products_custom_metaboxes_lang.ed_lang+'.js' : false,  // site absolute URL
					//---
					...
					plugins: 'textcolor image media hr uix_products_cmb_customcode colorpicker lists fullscreen',		
				    toolbar: toolbar,
					setup:function( ed ) {
					   ...
					   ed.on( 'change', function(e) {
						   ...
						   var newvalue = ed.getContent()
														 .replace(/\r?\n/gm, '' )
														 .replace(/\.\.\/wp-content\/uploads\//g, uix_products_custom_metaboxes_lang.upload_dir_url );
						...
						ed.addButton('uix_products_cmb_image', {
						...
						// Add link button
						ed.addButton('uix_products_cmb_link', {
							icon: 'mce-ico mce-i-link',
							tooltip: uix_products_custom_metaboxes_lang.ed_link_title,
							onclick: function (e) {
								...
								ed.windowManager.open( {
									title: uix_products_custom_metaboxes_lang.ed_link_title,
									body: [
									{
										type: 'textbox',
										label: uix_products_custom_metaboxes_lang.ed_link_field_url,
										name: 'link_url',
										value: curlinkURL,
										placeholder: 'https://',
										multiline: true,
									...
									{
										type: 'textbox',
										label: uix_products_custom_metaboxes_lang.ed_link_field_text,
										name: 'link_text',
										value: curlabel,
										multiline: true,
										minWidth: 500,
										...
										
									{
										...
										name: 'link_target',
										label: ' ',
										text: ' ' + uix_products_custom_metaboxes_lang.ed_link_field_win,
									},
						...
						//Delete link button
						ed.addButton('uix_products_cmb_unlink', {
							icon: 'mce-ico mce-i-unlink',
							tooltip: uix_products_custom_metaboxes_lang.ed_unlink_title,
							onclick: function (e) {
						...
						ed.addButton('uix_products_cmb_highlightcode', {
							...
							tooltip: uix_products_custom_metaboxes_lang.ed_hcode_title,
							onclick: function (e) {
								
								
								ed.windowManager.open( {
									title: uix_products_custom_metaboxes_lang.ed_hcode_title,
									body: [
                                        {
                                            type   : 'listbox',
                                            name   : 'lang',
                                            label  : uix_products_custom_metaboxes_lang.ed_hcode_field_label,
                                            values : [
                                                { value: 'xml', text: 'xml' },
                                                { value: 'css', text: 'css' },
				  ...
				  content_css: [
					uix_products_custom_metaboxes_lang.ed_url + 'css/uix-custom-metaboxes-editor.css'
				  ]
				});	
			}
...
( function ( $ ) {
	'use strict';
    $.fn.UixProductsEditorInit = function( options ) {
...
( function ( $ ) {
	'use strict';
    $.fn.UixProductsToggleSelectInit = function( options ) {
 
        // This is the easiest way to have default options.
        const settings = $.extend({
            wrapper           : '.uix-products-cmb__text--div--toggle.uix-products-cmb__text--div--toggle-customlevel',
            wrapperChild      : '.uix-products-cmb__text--div--toggle--child',
            fieldSelect       : '.uix-products-cmb__text--div--toggle__sel', 
            fieldId           : '.uix-products-cmb__text--div--toggle__id',
            fieldTitle        : '.uix-products-cmb__text--div--toggle__title',
            fieldDefaultValue : '.uix-products-cmb__text--div--toggle__toggleSelect',
            trigger           : '.uix-products-cmb__text--div--toggle__trigger'
        }, options );
			...
			*/
			...
			const updateAppearance = function( data, stylesAndOrderUpdate ) {
				...
				*/	
				...
				$listItemsContainer.find( 'textarea.uix-products-cmb__custom-attributes-field__resultData' ).val( createPHPData(variableResDataSortAllReversed) );

				$listItemsContainer.find( 'textarea.uix-products-cmb__custom-attributes-field__resultReverseData' ).val( createPHPData(variableResDataSortAll) );
			...
			const selectBuilder = function( data, parentID, removeID ) {
				let html_code = '<select class="uix-products-cmb__text--fullwidth uix-products-cmb__text--div--toggle__sel">';
				...
				$( settings.wrapper ).each( function()  {
					...
					for (let k = 0; k < hasParentIDsRes.length; k++) {
						if (hasParentIDsRes[k] === _cid ) {
							let _codeEmpty = '<select class="uix-products-cmb__text--fullwidth uix-products-cmb__text--div--toggle__sel">';
					...
					//
					$wrapper.find( '.uix-products-cmb__text--div--toggle__toggleSelect__append' ).html( _code ).promise().done( function(){

						//init default value for select control
						$wrapper.find( '.uix-products-cmb__text--div--toggle__toggleSelect__append > select' ).val( _pid );
			...
			//
			$( document ).off( 'change.UixProductsToggleSelect' ).on( 'change.UixProductsToggleSelect', settings.wrapper + ' .uix-products-cmb__text--div--toggle__toggleSelect__append > select', function() {
			...
			//
			$( document ).off( 'change.UixInputTextarea' ).on( 'change.UixInputTextarea', settings.wrapper + ' .uix-products-cmb__text--div--toggle__title, ' + settings.wrapper + ' .uix-products-cmb__text--div--toggle__classname, ' + settings.wrapper + ' .uix-products-cmb__text--div--toggle__textarea, ' + settings.wrapper + ' textarea[data-enter-value="true"]', function() {
...
( function ( $ ) {
	'use strict';
    $.fn.UixProductsToggleSimpleSelectInit = function( options ) {
 
        // This is the easiest way to have default options.
        const settings = $.extend({ 
            type              : 'file',
            wrapper           : '.uix-products-cmb__text--div--toggle:not(.uix-products-cmb__text--div--toggle-customlevel)',
            trigger           : '.uix-products-cmb__text--div--toggle__trigger'
        }, options );
        ...
        this.each( function( index ) {
            ...
            switch( defaultVal ) {
                case 'file':
                $this.closest( settings.wrapper ).find( '.uix-products-cmb__text--row[data-type="file"]' ).show();
                $this.closest( settings.wrapper ).find( '.uix-products-cmb__text--row[data-type="html"]' ).hide();
                break;

                case 'html':
                $this.closest( settings.wrapper ).find( '.uix-products-cmb__text--row[data-type="file"]' ).hide();
                $this.closest( settings.wrapper ).find( '.uix-products-cmb__text--row[data-type="html"]' ).show();
                break;      
            }      
            ...
            $this.off( 'change.UixProductsToggleSimpleSelect' ).on( 'change.UixProductsToggleSimpleSelect', function() {
 ...
 *************************************
 */	
function UixProductsGUIDCreate() {
 ...
 *************************************
 */	
function UixProductsGetRealIds( targetID ) {
