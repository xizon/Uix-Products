	...
	UixProductsCustomMetaboxesConstructor.prototype = {
		...
		getInstance: function() {
			...
			jQuery( document ).ready( function() {
                ...
                UixProductsCustomMetaboxesConstructor.prototype.editor.call( this );
		...
		editor: function() {
			...
			jQuery( document ).ready( function() {
                ...
                //Initialize Editor
                jQuery( '.uix-products-cmb__mce-editor' ).UixProductsEditorInit();
					...
					$addButton.off( 'click.UixProductsCustomMetaboxes_customAttrs_add' ).on( 'click.UixProductsCustomMetaboxes_customAttrs_add', function( e ) {
						...
						if( x < maxField ){ 
                            ...
                            jQuery.when( jQuery( wrapperID ).length > 0 ).then( function() {
                                ...
                                //Initialize Editor
                                UixProductsCustomMetaboxesInit.editor();
