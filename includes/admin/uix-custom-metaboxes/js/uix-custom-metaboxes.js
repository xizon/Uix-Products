 ...
 *************************************************
 */
var UixProductsCustomMetaboxes = function( obj ) {
	"use strict";


	var UixProductsCustomMetaboxesConstructor = function( obj ) {
		this.init = obj;
	};
	...
	UixProductsCustomMetaboxesConstructor.prototype = {
		...
		titleChange: function( wrapper, trigger, title ) {
			...
			jQuery( document ).ready( function() {
                jQuery( document ).off( 'input.UixProductsTitle change.UixProductsTitle' ).on( 'input.UixProductsTitle change.UixProductsTitle', title, function() {
		...
		toggleSelect: function() {
			...
			jQuery( document ).ready( function() {
                ...
                jQuery( '.uix-products-cmb__wrapper.uix-products-cmb__custom-attributes-field' ).UixProductsToggleSelectInit();
		...
		upload: function() {
			...
			jQuery( document ).ready( function() {
                ...
                var selector = '.uix-products-cmb__upload-target';
                var videoReg = /^.*\.(avi|AVI|wmv|WMV|flv|FLV|mpg|MPG|mp4|MP4)$/gi;
                
                //Custom selectors
				jQuery( selector ).each( function()  {
					var $this     = jQuery( this ),
                        uuid      = UixProductsGUID.create(),
					...
					if ( jQuery( '#' + tid ).val() != '' ) {
					 ...
					 //Delete image   
                    $this.next( _closebtn ).off( 'click.UixProductsUploadClose' ).on( 'click.UixProductsUploadClose', function( event ){
                    ...
                    //Prevent duplicate function assigned
                    $this.off( 'click.UixProductsUpload' ).on( 'click.UixProductsUpload', function( e ) {
                        e.preventDefault();
				...
				jQuery( selector ).each(function(){
					...
					$addButton.off( 'click.UixProductsCustomMetaboxes_customAttrs_add' ).on( 'click.UixProductsCustomMetaboxes_customAttrs_add', function( e ) {
						...
						if( x < maxField ){ 
                            ...
                            var uuid = UixProductsGUID.create();
                            ...
                            jQuery.when( jQuery( wrapperID ).length > 0 ).then( function() {
                                ...
                                UixProductsCustomMetaboxesInit.toggleSelect();
					...
					jQuery( document ).on( 'click.UixProductsCustomMetaboxes_customAttrs_remove', '.uix-products-cmb__custom-attributes-field__removebtn', function( e ) {
                        ...
                        if ( confirm( uix_products_custom_metaboxes_lang.delete_confirm_text ) ) {
                            var $li = jQuery( this ).closest( '.uix-products-cmb__text--div' );
...
//--------
var UixProductsCustomMetaboxesInit = new UixProductsCustomMetaboxes();
            ...
            if( typeof id !== typeof undefined ) {
				...
				tinymce.init({
					...
					setup:function( ed ) {
                        ...
                        //Add media button
						function uix_products_mce_insertImage() {
							var upload_frame;
							if( upload_frame ){
								upload_frame.open();
								return;
						...
						// Add link button
						ed.addButton('uix_products_link', {
						...
						//Delete link button
						ed.addButton('uix_products_unlink', {
						...
						ed.addButton('uix_products_highlightcode', {
...
( function ( $ ) {
    ...
    $.fn.UixProductsToggleSelectInit = function( options ) {
        ...
        // This is the easiest way to have default options.
        var settings = $.extend({
            wrapper           : '.uix-products-cmb__text--div--toggle',
        ...
        this.each( function() {
            ...
            $( this ).find( settings.wrapper ).each( function()  {
                ...
                //push options
                var options = '<option value="">'+uix_products_custom_metaboxes_lang.select_empty_text+'</option>';
                ...
                $sel.html( options ).promise().done( function(){
                    ...
                    $sel.off( 'change.UixProductsToggleSelect' ).on( 'change.UixProductsToggleSelect', function() {
 ...
 *************************************
 */	
var UixProductsGUID = UixProductsGUID || ( () => {
    function t() {
        do {
