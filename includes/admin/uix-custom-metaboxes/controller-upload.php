...
if ( !class_exists( 'Uix_Products_UploadMedia' ) ) {
	...
	class Uix_Products_UploadMedia {
		...
		public static function add( $args, $echo = true ) {
			...
			$code =  '
			<div class="uix-products-cmb__btn--upload-container '.( $child ? 'uix-products-cmb__btn--upload-container--child' : '' ).'">
				...
				<a href="javascript:" class="uix-products-cmb__removebtn" data-insert-img="'.esc_attr( $id ).'" data-insert-preview="'.esc_attr( $id ).'_preview" title="'.esc_attr( $label_remove ).'" style="display:none"><svg version="1.1"id="Layer_1"xmlns="http://www.w3.org/2000/svg"xmlns:xlink="http://www.w3.org/1999/xlink"x="0px"y="0px"viewBox="0 0 24 24"style="enable-background:new 0 0 24 24;"xml:space="preserve"><g id="remove"><path id="path_15_"d="M16.825,15.036l-1.787,1.788c-0.098,0.099-0.26,0.099-0.358,0L12,14.146l-2.679,2.679c-0.098,0.098-0.26,0.098-0.358,0l-1.788-1.788c-0.098-0.099-0.098-0.26,0-0.358l2.679-2.679L7.176,9.32c-0.098-0.098-0.098-0.26,0-0.358l1.788-1.787c0.099-0.098,0.26-0.098,0.358,0L12,9.853l2.679-2.679c0.098-0.098,0.26-0.098,0.358,0l1.788,1.788c0.098,0.098,0.098,0.26,0,0.358l-2.678,2.678l2.679,2.679C16.923,14.776,16.923,14.937,16.825,15.036z"/></g></svg></a>
				'.( !empty( $value ) ? '<div id="'.esc_attr( $id ).'_preview" class="uix-products-cmb__upload-preview" style="display:block"><img src="'.esc_attr( $value ).'" alt=""></div>' : '<div id="'.esc_attr( $id ).'_preview" class="uix-products-cmb__upload-preview"><img src="" alt=""></div>' ).' 
