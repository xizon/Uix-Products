...
* @print: 
	...
	if ( is_array( $_data ) && sizeof( $_data ) > 0 ) {
		...
		?>
			<li>
				<strong><?php echo esc_html( Uix_Products_Custom_Metaboxes::parse_jsondata_from_editor( $value[ 'name' ] ) ); ?></strong>
				<p>
...
*
*/
class UixProductsCmbFormType_CustomAttrs extends Uix_Products_Custom_Metaboxes {
