...
class cmb_uix_Meta_Box_ajax {
	...
	public static function get_oembed( $url, $object_id, $args = array() ) {
		...
		if ( $check_embed && $check_embed != $fallback )
			return '<div class="embed_status">'. $check_embed .'<p class="cmb_uix_remove_wrapper"><a href="#" class="cmb_uix_remove_file_button" rel="'. $args['field_id'] .'">'. __( 'Remove Embed', 'uix-products' ) .'</a></p></div>';
