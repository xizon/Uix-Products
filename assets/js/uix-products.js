( function($) {
	...
	$( function() {
		 ...
		 *************************************
		 */
		$( '[data-uix-products-slideshow="1"]' ).each( function()  {

			 var $this     = $( this );

			$this.UixProductsSlideshow({
		...
		$( "a[rel^='uix-products-slider-prettyPhoto']" ).prettyPhoto({
...
/* 
 *************************************
 * Custom Slidershow for Uix Products
...
( function ( $ ) {
	'use strict';
    $.fn.UixProductsSlideshow = function( options ) {
        ...
        this.each( function() {
            ...
            function sliderInit( resize ) {
                ...
                $sliderWrapper.each( function()  {
                    ...
                    var $this                    = $( this ),
                        $items                   = $this.find( '.uix-products-slideshow__item' ),
                        $first                   = $items.first(),
                        nativeItemW,
                        nativeItemH,
            ...
            function sliderAutoPlay( playTimes, timing, loop, slider, countTotalID, countCurID, paginationID, arrowsID ) {	
                ...
                var items = slider.find( '.uix-products-slideshow__item' ),
                    total = items.length;
            ...
            function addItemsToStage( slider, nativeItemW, nativeItemH, paginationID, arrowsID, loop, draggable, draggableCursor, countTotalID, countCurID ) {
                ...
                if ( $( arrowsID ).length == 0 ) {
                    $( 'body' ).prepend( '<div style="display:none;" class="uix-products-slideshow__arrows '+arrowsID.replace('#','').replace('.','')+'"><a href="#" class="uix-products-slideshow__arrows--prev"></a><a href="#" class="uix-products-slideshow__arrows--next"></a></div>' );
                }
                ...
                //Next/Prev buttons
                //-------------------------------------		
                var _prev = $( arrowsID ).find( '.uix-products-slideshow__arrows--prev' ),
                    _next = $( arrowsID ).find( '.uix-products-slideshow__arrows--next' );
                ...
                //Mouse event
                $dragDropTrigger.on( 'mousedown.UixProductsSlideshow touchstart.UixProductsSlideshow', function( e ) {
                    ...
                    $dragDropTrigger.on( 'mouseup.UixProductsSlideshow touchmove.UixProductsSlideshow', function( e ) {
                        ...
                        if ( touches && touches.length ) {
                            ...
                            if ( Math.abs( deltaX ) >= 50 || Math.abs( deltaY ) >= 50 ) {
                                $dragDropTrigger.off( 'touchmove.UixProductsSlideshow' );
                            }	
                            ...
                            if ( draggable ) {
                                ...
                                $dragDropTrigger.off( 'mouseup.UixProductsSlideshow' );
                    ...
                    } );//end: mouseup.UixProductsSlideshow touchmove.UixProductsSlideshow




                } );// end: mousedown.UixProductsSlideshow touchstart.UixProductsSlideshow
            ...
            function sliderUpdates( elementIndex, slider, dir, countTotalID, countCurID, paginationID, arrowsID, loop ) {
                ...
                if ( loop ) {
                    ...
                    $( arrowsID ).find( 'a' ).removeClass( 'is-disabled' );
                    if ( elementIndex == total - 1 ) $( arrowsID ).find( '.uix-products-slideshow__arrows--next' ).addClass( 'is-disabled' );
                    if ( elementIndex == 0 ) $( arrowsID ).find( '.uix-products-slideshow__arrows--prev' ).addClass( 'is-disabled' );
                }
                ...
                if ( isTouchCapable ) {
                    ...
                    if ( !loop ) {
                        //first item
                        if ( elementIndex == 0 ) {
                            $( arrowsID ).find( '.uix-products-slideshow__arrows--prev' ).addClass( 'is-disabled' );
                        }

                        //last item
                        if ( elementIndex == total - 1 ) {
                            $( arrowsID ).find( '.uix-products-slideshow__arrows--next' ).addClass( 'is-disabled' );
                        }	
                    }
                ...
                slider.find( '.uix-products-slideshow__item.is-active' ).removeClass( 'is-active' ).addClass( 'leave ' + dirIndicatorClass );
            ...
            function itemDefaultInit( slider, currentLlement ) {
                ...
                if ( currentLlement.find( 'video' ).length > 0 ) {
                    ...
                    currentLlement.find( 'video' ).css({
                        'width': currentLlement.closest( '.uix-products-slideshow__outline' ).width() + 'px'
                    });   
                    
                    
                    video.addEventListener( 'loadedmetadata', function( e ) {

                        slider.css( 'height', this.videoHeight*(currentLlement.closest( '.uix-products-slideshow__outline' ).width()/this.videoWidth) + 'px' );	
                    ...
                    if ( typeof imgURL != typeof undefined ) {
                        ...
                        img.onload = function() {
                            ...
                            slider.css( 'height', currentLlement.closest( '.uix-products-slideshow__outline' ).width()*(this.height/this.width) + 'px' );		
